...
public class ContactDBHelper extends SQLiteOpenHelper {
  ...
  private static final String DATABASE_NAME = "mycontactslist.db";
  private static final int DATABASE_VERSION = 3;
	private static final String ALTER_TABLE_CONTACT_ADD_BFF = "ALTER TABLE contact ADD COLUMN BFF integer";
  ...
  private static final String CREATE_TABLE_CONTACT =
	...
	try {
			...
			//db.execSQL(ALTER_TABLE_CONTACT_ADD_BFF);
		}
		catch (Exception e) {
			//do nothing
		}
