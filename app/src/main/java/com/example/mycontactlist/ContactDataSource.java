	...
	public boolean insertContact(Contact c) 
	{
		...
		try {
			...
			try {
				...
				System.out.println("Error while saving photo");
			}
			didSucceed = database.insert("contact", null, initialValues) > 0;
			System.out.println("SAVE DONE!! "+ didSucceed);
		}
		catch (Exception e) {
...
ByteArrayOutputStream baos = new ByteArrayOutputStream();  
    ...
    // Q5.2 update method to update contact address only.
    public void updateContactAddress(ContactAddress c, ContentValues values)
    {
        try {
            values.put("streetaddress", c.getStreetAddress());
