...
public class ContactMapActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//ActivityCompat.requestPermissions(ContactMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
	...
	public boolean checkPermission(String permission) {
		if (ContextCompat.checkSelfPermission(ContactMapActivity.this, permission)
    	...
    	private SensorEventListener mySensorEventListener = new SensorEventListener() {
    	    ...
    	    if (accelerometerValues!= null && magneticValues!= null) {
    	        ...
    	        if (success) {
					...
					else if (azimut >= 22.5 && azimut < 67.5) { direction = "NE"; }
